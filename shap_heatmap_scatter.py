...
def main():
    ...
    for class_label in tqdm([0, 1], desc="Generating heatmaps", unit="class"):
        ...
        heatmap_path = os.path.join(args.output_dir, f"shap_heatmap_class{class_label}_" f"n_{sample_size}.png") 
    ...
    def save_scatter(feature, shap_values_class, class_label, class_scatter_dir):
        ...
        save_path = os.path.join(class_scatter_dir, f"shap_scatter_{feature}_class{class_label}_confirmation.png" )
    ...
    for class_label in tqdm([0, 1], desc="Scatter plot classes", unit="class"):
        ...
        class_scatter_dir = os.path.join(args.output_dir, f"class_{class_label}")
